                 ...
                 <div className="container">
                    ...
                    <div className="container howitworks">
                        <div className="row howitworks-text">
                           ...
                           <div className="col-lg-12 how-paragraph">
                           One year ago we started on a journey with one thing in mind: creating a better experience for gamers everywhere.So, 1150 unique customers and 1300 trades later, we can now proudly call ourselves one of the best Metin2 traders on the market. And we are still on the rise.
                            </div>

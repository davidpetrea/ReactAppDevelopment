                ...
                <div>
                    ...
                    <div className="showcase-text">
                        ...
                        <div className="container servers">
                            <div className="row">
                                <Server image={backgroundEkstasia} serverName="Origins II" price="40kkk Yang = 10 €" serverDescription="With over 2000 players online, Origins2 has been a stable server for the past 8 months, enjoyable for those of you who are looking for a PvM – medium experience."/>
                            ...
                            <div  className="row">
                                ...
                                <Server image={backgroundAeldra} serverName="Xaleas" price="1kkk Yang = 10 €" serverDescription="Xaleas is a brand new server that nailed the perfect combination of oldschool and middleschool. With a nice progressive system focused on PvM, this server will surely make you want to stay."/>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                <Server image={background11} serverName="Communio" price="40 kk = 10 €" serverDescription="Communio represents exactly what is says: a place for everyone, a fresh start where new adventurers can join and compete in the long run."/>
                                <Server image={background12} serverName="Sodalitas" price="45 kk = 10 €" serverDescription="Sodalitas is the clearest example of what the Metin2 community needs: high-quality, stable experiences of the oldschool grind that everyone is nostalgic for. "/>
                            </div>

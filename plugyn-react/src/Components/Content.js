                ...
                <div>
                    ...
                    <div className="showcase-text">
                        ...
                        <div className="container servers">
                            ...
                            <div className="row">
                                <Server image={backgroundCelestial} serverName="Rubinum" price="19kkk = 10 €" serverDescription="After a year long break, Rubinum, the genre defining private server, is finally back. There is no better time than now to join and climb the ladder of most promising private server out there at the moment."/>
                            ...
                            <div  className="row">
                                ...
                                <Server image={backgroundAeldra} serverName="Xaleas" price="10kkk Yang = 10 €" serverDescription="Xaleas is a brand new server that nailed the perfect combination of oldschool and middleschool. With a nice progressive system focused on PvM, this server will surely make you want to stay."/>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                ...
                                <Server image={background8} serverName="Germania" price="1.1 € = 1 won" serverDescription="As part of the most populated official server, the old Genesis community will make sure you have a great time and enjoy the experience."/>
                            </div>
                            <div className="row">
                                <Server image={background9} serverName="Teutonia" price="1.1 € = 1 won" serverDescription="As any other official server, Teutonia takes the meaning of balanced and long lasting oldschool gaming experiences to the next level."/>
                            ...
                            <div className="row">
                                <Server image={background11} serverName="Communio" price="150 kk = 10 €" serverDescription="Communio represents exactly what is says: a place for everyone, a fresh start where new adventurers can join and compete in the long run."/>
                                <Server image={background12} serverName="Sodalitas" price="100 kk = 10 €" serverDescription="Sodalitas is the clearest example of what the Metin2 community needs: high-quality, stable experiences of the oldschool grind that everyone is nostalgic for. "/>
                            </div>

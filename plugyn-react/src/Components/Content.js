                ...
                <div>
                    ...
                    <div className="showcase-text">
                        ...
                        <div className="container servers">
                            ...
                            <div className="row">
                                <Server image={background6} serverName="Nexus II" price="2kkk Yang = 10 €" serverDescription="The definition of a PvM experience, this server brings a great deal of content to the table. An ever-growing community that actually makes its voice heard awaits for you!"/>

                ...
                <div>
                    ...
                    <div className="showcase-text">
                        ...
                        <div className="container servers">
                            <div className="row">     
                                 <Server image={backgroundCelestial} serverName="Rubinum" price="2 kkk = 10 €" serverDescription="After a year long break, Rubinum, the genre defining private server, is finally back. There is no better time than now to join and climb the ladder of most promising private server out there at the moment."/>
                            </div>
                            <div className="row">
                            ...
                            <div  className="row">
                                ...
                                <Server image={backgroundAeldra} serverName="Xaleas" price="3kkk Yang = 10 €" serverDescription="Xaleas is a brand new server that nailed the perfect combination of oldschool and middleschool. With a nice progressive system focused on PvM, this server will surely make you want to stay."/>
                            </div>
                            <div className="row">
                                ...
                                <Server image={background5} serverName="Evion II" price="3kkk Yang = 10 €" serverDescription="Beginner-friendly and International, Evion2 is sure to please those of you who are looking for an adventure. Grab your friends and jump in this promising PvM experience together."/>
                            </div>
                            <div className="row">
